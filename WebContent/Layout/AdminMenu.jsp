...
<!-- left column (products and features) -->
		<div id="leftcolumn">
			<h3 class="leftbox">Administrator Menu</h3>
			<ul class="leftbox borderedlist">
				<li><a href="/NexusBankingGroup/EmployeeManageServlet?action=Register">Register Employee</a></li>
				<li><a href="/NexusBankingGroup/EmployeeManageServlet?action=ViewEmployees">View Employee</a></li>
				<li><a href="/NexusBankingGroup/EmployeeManageServlet?action=ViewEmployees">Search Employee</a></li>
