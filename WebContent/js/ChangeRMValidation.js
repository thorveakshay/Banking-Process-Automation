...
{
	// function to check whether branch has been selected
		whichindex=document.branchform.selbranch.selectedIndex;
		if(whichindex==0)
		{
...
// function to check whether relationship manager has been selected
