...
<title>Update Personal Party Contact</title>
...
NonPersonalCustomer npc = new NonPersonalCustomer();
 ...
 pp=(PersonalParty)request.getAttribute("pesonalParty");
...
<table id="gradient-style" align="center" style="margin-left: 200px">

<tr>
	<td width="40%"><font size="2pt"><b>Ticket Id</b></font></td>
     	<td ><font size="2pt"><%=tick.getId() %></td>
</tr>
<tr>
...
-->
<div style="font: 150%/ 2.2em Lucida Grande, Tahoma, Verdana, Arial, Helvetica,sans-serif;margin-left:230px;">
<center><input type="submit" style="background-color:black;margin-top:20px;  color:white" value="Submit"/>
