...
<!-- Start Main Content -->
	...
	<div id="center">
		<div class="article_wrapper" style="width: 600px;">
			 ...
			 <td colspan="3" align="left" style="height: 35px">Employee Details</td>
				</tr>
				<tr></tr><tr></tr><tr></tr>   -->
				<!--<tr><td></td><td></td><td></td><td></td><td></td><td></td><td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><a href="<%=request.getContextPath()%>/EmployeeManageServlet?action=ViewEmployees"><font size="3px"><u>Back</u></font></a></td></tr>
				<tr>
				-->
				
				<tr><td style="font-color=#5599a7" width="700px"><b>Employee ID</b></td>
				<td width="500px"><%=emp.getId()%></td>
				<td width="300px"></td>
				...
				<td colspan="2" align="center" style="padding-left:35px"><br/><br/>
