...
<title>Update Non Personal Party Address Details</title>
...
<h3><font color="black" size="5pt"><center>Ticket Summary</center></font></h3><br>

  <hr>
 
<input type="hidden" name="action" value="address_tkt_hidden"/>
...
<tr>
	<td width="40%"><font size = "2pt"><b>Ticket Id</b></font></td>
     	<td width=60%><font size = "2pt"><%=tick.getId()%></font></td>
</tr>
<tr>
