...
<div  style="color:white;background-color: #5599a7; height: 35px;width: 800px">
						<p  style ="font-size:20px ; padding-left:10px;padding-top: 5px;padding-bottom:5px">ACTIVATE EMPLOYEE</p><br/>
				 	</div>
				 	
<br/>

<form name="f1" action="/NexusBankingGroup/EmployeeManageServlet"
	><input type="hidden" name="action" value="activateEmployeeDetails" />
...
<td></td><td></td><td></td><td><a href="/NexusBankingGroup/jsp/ViewProfile.jsp" onclick="return navigateconfirm();"><font size="3px"><u>Back</u></font></a></td>
	...
	--><tr>
		...
		<td><input type="radio" name="status" <%="checked"%> value="ACTIVE">Active
		<input type="radio" name="status" value="INACTIVE" disabled>Inactive
		</td>
	</tr>
	<!--<tr>
		<td><b>Date of Leaving<font color="red">*</font></b></td>
		<td><input type="text" name="dateOfLeaving" onblur="validateLeavedate()"><a href="#"
	...
	<tr>
		<td></td>
		<td><input id="b1" name="button1" type="submit" value="Update" onclick="return validateReason()"/>
